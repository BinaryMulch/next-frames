...
const ThemeToggle = () => {
	...
	return (
		<button
			onClick={toggleTheme}
			className="w-10 h-10 rounded-xl bg-amber-50 hover:bg-amber-100 dark:bg-indigo-900/30 dark:hover:bg-indigo-900/50 flex items-center justify-center transition-all duration-200 border border-amber-200 dark:border-indigo-700/50"
