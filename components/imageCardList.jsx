			...
			{!isLoading ? (
				images.length > 0 ? (
					...
					<div className="flex-1 flex items-center justify-center p-4">
						<div className="text-center">
							...
							<p className="text-gray-400 dark:text-gray-500 text-xs mt-1">Upload your first image above</p>
						</div>
					</div>
				)
			) : (
				<div className="flex-1 flex justify-center items-center">
					<div className="text-center">
						...
						<p className="text-sm text-gray-600 dark:text-gray-400 mt-3">Loading images...</p>
					</div>
				</div>
			)}
		</div>
